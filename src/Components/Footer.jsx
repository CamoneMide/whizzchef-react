  ...
  return (
    <>
      <div className="text-[var(--text-heading)] px-[30px] bg-[var(--area-bg-color)]">
        <div className="flex flex-col items-center md:justify-between md:flex-row text-[12px] md:text-[14px] font-[400] text-textBlack border-t-[1px] border-t-[var(--area-bg-color)] py-[10px]">
